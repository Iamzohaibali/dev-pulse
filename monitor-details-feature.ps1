...
Set-Location ..
Write-Host "Done: stats endpoint (backend), MonitorDetailModal + updated Dashboard (frontend)" -ForegroundColor Green
Write-Host "Restart both dev servers to pick up changes." -ForegroundColor Yellow